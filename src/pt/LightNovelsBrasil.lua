-- {"id":172007,"ver":"1.0.0","libVer":"1.0.0","author":"felipebonfim2006","dep":["url>=1.0.0"]}

-- ============================= CONSTANTS ==============================
local id = 172007
local baseURL = "https://lightnovelbrasil.com"
local name = "Light Novels Brasil"
...
local function shrinkURL(url)
  return url:gsub("^.-lightnovelbrasil%.com", "")
end
...
local function parseNovel(novelURL)
  ...
  local img = document:selectFirst("img.ts-post-image.wp-post-image.attachment-medium.size-medium")
  local info = document:selectFirst("div.ninfo > b > div.info-content")
...
return {
  ...
  name = name,
  baseURL = baseURL,
  imageURL = expandURL("/wp-content/uploads/2022/11/cropped-logo.png"),
  listings = {
